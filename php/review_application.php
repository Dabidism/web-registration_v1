    ...
    if (isset($_POST['action'])) {
        ...
        if ($action === 'approve') {
            ...
            try {
                ...
                $updateQuery = "UPDATE applications SET registrationStatus = ?, OwnerID = ? WHERE fName = ? AND lName = ? AND email = ?";
                $updateStmt = $conn->prepare($updateQuery);
                $updateStmt->bind_param("sssss", $status, $uniqueCode, $applicant['fName'], $applicant['lName'], $applicant['email']);
                $updateStmt->execute();
            ...
            $updateQuery = "UPDATE applications SET registrationStatus = ? WHERE fName = ? AND lName = ? AND email = ?";
            $updateStmt = $conn->prepare($updateQuery);
            $updateStmt->bind_param("ssss", $status, $applicant['fName'], $applicant['lName'], $applicant['email']);
    ...
    <div class="review-container">
        <div class="review-section application-header">
            ...
            <div class="application-date">
                Submitted: <?php echo isset($applicant['applicationDate']) && !empty($applicant['applicationDate']) ? date('F j, Y \a\t g:i A', strtotime($applicant['applicationDate'])) : 'Date not available'; ?>
            </div>
        </div>
        ...
        <div class="review-section">
            ...
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <span class="info-value"><?php echo htmlspecialchars($applicant['fName'] . ' ' . $applicant['mName'] . ' ' . $applicant['lName']); ?></span>
                </div>
                <div class="info-item">
                ...
                <div class="document-preview">
                    <?php if (!empty($applicant['drivers_license'])): ?>
                        ...
                        <div class="document-actions">
                            <a href="<?php echo htmlspecialchars($applicant['drivers_license']); ?>" class="btn-view" target="_blank">View Full Document</a>
                        </div>
                    <?php else: ?>
            ...
            <?php foreach ($vehicles as $index => $vehicle): ?>
                <div class="vehicle-card">
                    <div class="vehicle-header">
                        <h4>Vehicle #<?php echo $index + 1; ?>: <?php echo htmlspecialchars($vehicle['vehicleType']); ?></h4>
                        <div class="plate-number">Plate Number: <strong><?php echo htmlspecialchars($vehicle['plateNum']); ?></strong></div>
                    </div>
                            ...
                            <div class="document-col">
                                ...
                                <div class="document-preview">
                                    <?php if (!empty($vehicle['offical_receipt'])): ?>
                                        ...
                                        if (in_array(strtolower($ext), ['jpg', 'jpeg', 'png', 'gif'])): 
                                        ?>
                                            <img src="<?php echo htmlspecialchars($vehicle['offical_receipt']); ?>" alt="Official Receipt">
                                        <?php else: ?>
                                            <div class="document-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                    <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/>
                                        ...
                                        <?php endif; ?>
                                        <div class="document-actions">
                                            <a href="<?php echo htmlspecialchars($vehicle['offical_receipt']); ?>" class="btn-view" target="_blank">View Full Document</a>
                                        </div>
                                    <?php else: ?>
                                        <div class="document-missing">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div class="document-col">
                                ...
                                <div class="document-preview">
                                    <?php if (!empty($vehicle['cert_of_registration'])): ?>
                                        ...
                                        if (in_array(strtolower($ext), ['jpg', 'jpeg', 'png', 'gif'])): 
                                        ?>
                                            <img src="<?php echo htmlspecialchars($vehicle['cert_of_registration']); ?>" alt="Certificate of Registration">
                                        <?php else: ?>
                                            <div class="document-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                    <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/>
                                        ...
                                        <?php endif; ?>
                                        <div class="document-actions">
                                            <a href="<?php echo htmlspecialchars($vehicle['cert_of_registration']); ?>" class="btn-view" target="_blank">View Full Document</a>
                                        </div>
                                    <?php else: ?>
                                        <div class="document-missing">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div id="rejectModal" class="modal hidden">
            <div class="modal-content">
                ...
                <textarea id="rejectReasonText" placeholder="Enter reason for rejection..." rows="4" class="reject-reason-textarea"></textarea>
                <div class="modal-buttons">
                    <button type="button" onclick="closeRejectModal()" class="btn-cancel">Cancel</button>
                    <button type="button" onclick="submitRejection()" class="btn-confirm-reject" id="confirmRejectBtn">Decline Application</button>
                </div>
            </div>
        </div>
        <?php endif; ?>
