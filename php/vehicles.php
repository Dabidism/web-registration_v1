  ...
  <div class="modal-content">
    ...
    <form id="editForm">
      ...
      <div class="form-group">
        ...
        <input type="text" id="editRFID" name="rfid">
      </div>
      ...
      <div class="form-group">
        <label>Admin Password:</label>
        <input type="password" id="editVehicleAdminPassword" required
          placeholder="Enter your admin password to confirm">
      </div>

      <button type="button" id="saveEdit" class="btn-save">Save</button>
    </form>
  </div>
</div>
...
<div id="addModal" class="modal">
  <div class="modal-content">
    ...
    <form id="addForm">
      ...
      <div class="form-group">
        <label>Admin Password:</label>
        <input type="password" id="addVehicleAdminPassword" required placeholder="Enter your admin password to confirm">
      </div>
